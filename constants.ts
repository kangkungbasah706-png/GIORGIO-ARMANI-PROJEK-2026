...
export const CATALOGS_DATA: CatalogGroup[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: 20, label: "PRODUK D", name: "AX2104", price: 6100000, commission: 40, profit: 2440000, imageUrl: "https://i.pinimg.com/1200x/69/85/13/698513a55b4674679a024c2d5957c45a.jpg", statusText: "Cek Detail" }
    ]
  },
  {
    name: "SHOES",
